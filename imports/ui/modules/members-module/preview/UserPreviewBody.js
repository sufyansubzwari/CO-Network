...
class UserPreviewBody extends React.Component {
    ...
    renderSummarySection = () => {
        ...
        const render =
            ...
            website ||
            user.aboutMe ||
            user.aboutMe.yourPassion || !this.props.id;
        ...
        return render ? (
            <PreviewSection previewRef={this.SummarySection}>
                ...
                <PlaceHolder
                    ...
                    width={300}
                >
                    {aboutMe && aboutMe.yourPassion ? <Container>
                        <Text
                            header={"About"}
    ...
    renderKnowledgeSection = () => {
        ...
        const render =
            ...
            (lookingfor && lookingfor.length) || !this.props.id;
        ...
        return render ? (
            ...
            >
                ...
                <PlaceHolder
                    ...
                    width={300}
                >
                    {lookingfor && lookingfor.length ? <TagsAdd
                        hideBorder={true}
                        activeColor={"white"}
    ...
    renderProfessionalSection = () => {
        ...
        return render ? (
            ...
            >
                ...
                >
                    {profesionalexp &&
                    profesionalexp.length > 0 ? <CollapseList cutElements={3} title={"Professional Experience"}>
    ...
    renderAcademicSection = () => {
        ...
        const render =
            ...
            (publications && publications.length) || !this.props.id;
