...
class JobPreviewBody extends React.Component {
  ...
  renderRequirementsSection = () => {
    ...
    return languages.length ||
      ...
      <PreviewSection
        title={"Requirements"}
        previewRef={this.RequirementsSection}
      >
  ...
  renderCultureSection = () => {
    return this.state.job.culture ||
      ...
      <PreviewSection
        title={"Employer Culture"}
        previewRef={this.EmployerSection}
      >
      ...
      >
        {({ loading, error, data }) => {
          ...
          return data && data.jobsApply && data.jobsApply.length ? (
            <PreviewSection
              title={"Applicants"}
              number={data.jobsApply.length}
              previewRef={this.ApplicantsSection}
            >
              <Layout
                colGap={"20px"}
