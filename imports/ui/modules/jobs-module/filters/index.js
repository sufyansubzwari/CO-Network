        ...
        return (
            ...
            <FiltersContainer width={'252px'} height={'100%'}>
                <Scrollbars universal autoHide autoHideDuration={200} style={{height: '100%'}}>
                    ...
                    <Separator/>
                    <Filter>
                        <CheckBoxList placeholderText={'Job Type'} options={JOB_TYPE_NUMBER}/>
                    </Filter>
                    <Separator/>
                    <Filter>
                        <CheckBoxList placeholderText={'Experience Requiered'} options={EXPERIENCE_REQUIERED_NUMBER}/>
                    </Filter>
                    <Separator/>
                    <Filter>
                        <InputAutoComplete placeholderText={'Industry | Sector'} name={'industry'} model={this.state}
                                           options={[
                        ...
                        <Layout mt={'10px'} customTemplateColumns={'80px 80px 80px'} colGap={'10px'}>
                            ...
                            <BigTag  text={'Application & BioInformatics'} icon={'label'} connected={true}/>
                        </Layout>
                    </Filter>
                    <Separator/>
                    <Filter>
