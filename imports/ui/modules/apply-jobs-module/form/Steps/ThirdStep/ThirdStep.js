...
class ThirdStep extends React.Component {
  ...
  tagsSuggested(tags, name) {
    ...
    if(name && this.state.apply.professional && this.state.apply.professional[name]){
      return sug
        .filter(tag =>
          !this.state.apply ||
          !this.state.apply.professional ||
                            ...
                            return (
                              <Container mt={'25px'}>
                                <MLTagsInput
                                  ...
                                  useIcon={true}
                                  tags={
                                    this.state.apply.professional && this.state.apply.professional.expertise
                            ...
                            return (
                              <Container mt={'25px'}>
                                <MLTagsInput
                                  ...
                                  useIcon={true}
                                  tags={
                                    this.state.apply.professional && this.state.apply.professional.languages
