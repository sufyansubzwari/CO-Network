                ...
                <FiltersContainer width={'252px'} height={'100%'}>
                    <Scrollbars universal autoHide autoHideDuration={200} style={{height: '100%'}}>
                        <Layout customTemplateColumns={'1fr auto'} >
                            <h6>Filters</h6>
                            <SButton secondary={true} onClick={this.props.onClose} color={'black'} ><Icon><MaterialIcon type={'chevron-left'} /></Icon></SButton>
                        </Layout>
                        <Separator/>
                        <Filter>
                            <GeoInputLocation name={'location'} model={this.state} placeholder={'Location'}/>
                            <Layout mt={'10px'} customTemplateColumns={'70px 70px 70px'} colGap={'10px'}>
                        ...
                        <Separator/>
                        <Filter>
                            <CheckBoxList placeholderText={'Event Category'} options={[{
                                label: 'Hackthon',
                                active: true,
                                number: 12
