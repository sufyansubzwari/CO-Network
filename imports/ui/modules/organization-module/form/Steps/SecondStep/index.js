...
class SecondStep extends React.Component {
  ...
  notifyParent(model, name, value) {
    if (model && name && value) {
      ...
      organization.reason[name] = value;
      this.setState(
  ...
  render() {
    return (
      <Layout rowGap={"25px"}>
        <TextArea
          height={"100px"}
          model={this.state.organization.reason}
          name={"bio"}
          placeholderText={"Org Bio"}
        ...
        <TextArea
          ...
          model={this.state.organization.reason}
          name={"vision"}
          placeholderText={"Vision | Mission"}
          getValue={this.notifyParent.bind(this)}
        />
        <TextArea
          height={"100px"}
          ...
          name={"orgDefine"}
          placeholderText={
            "How does the organization define / measure success?"
          }
          getValue={this.notifyParent.bind(this)}
        />
      </Layout>
