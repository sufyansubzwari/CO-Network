...
const SText = styled.p`
    color: ${props => props.textColor ? props.textColor : props.theme.preview.text.textColor};
    font-family: ${props => props.textFamily ? props.textFamily : props.theme.preview.text.textFamily};
    font-size: ${props => props.textSize ? props.textSize : props.theme.preview.text.textSize};
    line-height: ${props => props.textLineHeight ? props.textLineHeight : props.theme.preview.text.textLineHeight};
    font-weight: ${props => props.textWeight ? props.textWeight : props.theme.preview.text.textWeight}    
`;
