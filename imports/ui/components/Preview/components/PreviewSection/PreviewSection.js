...
const STitle = styled.span`
    font-family: ${props => props.theme ? props.theme.preview.section.titleFamily : "Roboto Mono"};
    color: ${props => props.theme ? props.theme.preview.section.titleColor : "black"};        
    font-weight: bold;
    font-size: 16px;;
`;
...
PreviewSection = (props) => {
    return (
        <PreviewSectionContainer rowGap={'15px'}>
            <Container>
