        ...
        >
            <Layout rowGap={'10px'} style={{ background: "rgb(209,209,209,0.2)" }}>
                <Layout templateColumns={2} colGap={"20px"}>
                    <Select placeholderText={"Years Worked"} model={props.model} name={'years'} options={YEARS_EXPERIENCE} />
                    <Input
                ...
                <Input placeholderText={'Position'} name={'position'} model={props.model}/>
                <TextArea
                    placeholderText={
                        "Brief Description"
                    }
